...
final class EnclosureTest extends TestCase
{
    ...
    {
        $subject = new Enclosure('https://example.org/video.mp4');
    ...
    {
        $subject = new Enclosure('https://example.org/video.mp4', 'video/mp4');
    ...
    {
        $subject = new Enclosure('https://example.org/video.mp4', length: 1234567);
